...
var AppController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Route de base'), (0, common_1.Controller)()];
    ...
    var AppController = _classThis = /** @class */ (function () {
        ...
        AppController_1.prototype.create = function () {
        };
        AppController_1.prototype.patchOneValue = function (name) {
        };
        AppController_1.prototype.update = function () {
        };
        AppController_1.prototype.delete = function () {
        };
    ...
    (function () {
        ...
        _patchOneValue_decorators = [(0, common_1.Patch)()];
        ...
        __esDecorate(_classThis, null, _patchOneValue_decorators, { kind: "method", name: "patchOneValue", static: false, private: false, access: { has: function (obj) { return "patchOneValue" in obj; }, get: function (obj) { return obj.patchOneValue; } }, metadata: _metadata }, null, _instanceExtraInitializers);
